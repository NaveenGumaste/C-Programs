...
void sortStudentDetailsByName(struct Student students[], int count)
{
  struct Student temp;
  int i, j;
...
void sortStudentDetailsByRollNo(struct Student students[], int count)
{
  struct Student temp;
  int i, j;
...
int main()
{
  ...
  sortStudentDetailsByName(students, 3);

  printf("\n\tSorted Student Details by Name\n\n");
  for (int i = 0; i < 3; i++)
  {
    printf("Name: %s\nRoll No: %d\n", students[i].name, students[i].rollNo);
  }

  sortStudentDetailsByRollNo(students, 3);

  printf("\n\tSorted Student Details by Roll No\n\n");
  for (int i = 0; i < 3; i++)
  {
    printf("Name: %s\nRoll No: %d\n", students[i].name, students[i].rollNo);
  }
